...
const kselectedItemColor = kclubsideButtonSelectedTabColor;
...
const kclubsideTabbarBackgroundColor = Color(0xffC1C1FF);
const kclubsideButtonSelectedTabColor = Color(0xff3D55BE);
