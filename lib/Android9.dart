...
class Android9 extends StatelessWidget {
  const Android9({Key? key}) : super(key: key);
              ...
              child : Column(
                ...
                children : [
                  ...
                  SizedBox(
                      width: 82,
                      height: 30,
                      child : Text('MEET LINK',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15 ),),
                  ),
                  Container(
                    width: 328,
                      height : 40,
                    ...
                    child : Row(
                      ...
                      children: [
                        SizedBox(width : 17.5,),
                        Text('meet.google.com/fde-pycc-hbx', style: TextStyle(color : Colors.black),),
